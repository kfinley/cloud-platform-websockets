...
describe("connect", () => {
  ...
  const context = {
    ...
    functionName: 'Cloud-Platform-Dev-WebSockets-connect',
    functionVersion: '$LATEST',
    identity: undefined,
    invokedFunctionArn: 'offline_invokedFunctionArn_for_Cloud-Platform-Dev-WebSockets-connect',
    logGroupName: 'offline_logGroupName_for_Cloud-Platform-Dev-WebSockets-connect',
    logStreamName: 'offline_logStreamName_for_Cloud-Platform-Dev-WebSockets-connect',
